	...
	**********************************************************/
	...
	const loadData = async () => {
		let keydata = {
			...
			'filterName': filters.value.username,
			'filterEmail': filters.value.usermail,
			'filterRole': filters.value.role,
			'filterOnboard1': filters.value.onboard1,
			'filterOnboard2': filters.value.onboard2,
		...
		let url = `${APIsvr.value}/002_havelist.php?${sQuery}`
